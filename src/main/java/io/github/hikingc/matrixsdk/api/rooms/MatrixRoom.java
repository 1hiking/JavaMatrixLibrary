...
/// This record represents the configuration that the server will follow to configure the room. Not
/// all possible parameters are implemented but the most essential ones are.
///
...
/// @param userIds An array of user IDs to invite to the room. The server will be responsible for
...
/// @param roomAliasName If this is included, a room alias will be created and mapped to the newly
///   created room. The alias will belong on the same homeserver which created the room.
