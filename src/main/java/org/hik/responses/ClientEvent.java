...
/// The record used for events when they are returned from a homeserver to a client via the Client-Server API, or sent to an Application Service via the Application Services API.
///
...
public record ClientEvent(Map<String, Object> content,
    ...
    /// @param membership      the room membership of the user making the request, at the time of the event. More information in the specification.
